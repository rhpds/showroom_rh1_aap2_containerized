...
Welcome to the {lab_name} lab. This lab will walk you through
...
. Overview
. The second module will walk you through
...
2dcfee9e50c4  {guid} docker.io/library/httpd:2.4  httpd-foreground  3 hours ago  Up 3 hours  0.0.0.0:8080->80/tcp  showroom-httpd
----
