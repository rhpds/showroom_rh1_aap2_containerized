...
[NOTE]
====
The Red Hat Demo Team who deployed this lab makes use of both optimized instances and cloud-based DBaaS. The infrastructure for your lab today used AWS RDS as the database backend for AAP2.
====
